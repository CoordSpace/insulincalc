window.onload = function () {
  if (typeof (Storage) !== 'undefined') {
    ...
    var a = localStorage.getItem('targetBloodSugar')
    var b = localStorage.getItem('correctionFactor')
    var c = localStorage.getItem('insulinCarbRatio')

    // after page load, grab all the constants from the page's localStorage
...
$('.const-input').on('input', function () {
  ...
  localStorage.setItem('insulinCarbRatio', insulinCarbRatio)
